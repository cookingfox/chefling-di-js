...
function Container() {
    ...
    var _self = this;
    var _currentlyResolving = new Map();
    var _instances = new Map();
    var _mappings = new Map();
    ...
    this.remove = function (type) {
        ...
        var mappingsForType = _mappings.getKeysForValue(type);

        for (var t in mappingsForType) {
            _self.remove(mappingsForType[t]);
        }
    };
